...
import {
  EmailSentToRecoverPassword
} from "@/modules/users/components/EmailSentToRecoverPassword.tsx";
...
import {
  SendEmailToRecoverPasswordPage
} from "@/shared/pages/user/SendEmailToRecoverPasswordPage.tsx";
...
export function AuthRoutes() {
  return (
    ...
    >
      ...
      <Route path={"activation-email-resent"} element={<ActivationEmailResent />} />
      <Route path={"email-sent"} element={<EmailSent />} />
      <Route path={"recover-password"} element={<RecoverPasswordPage />} />
      <Route path={"recover-password-email-sent"} element={<EmailSentToRecoverPassword />} />
      <Route path={"resend-activation-email"} element={<ResendActivationEmailPage />} />
